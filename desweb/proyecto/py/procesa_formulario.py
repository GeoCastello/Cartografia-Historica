        ...
        ##PROCESO PARA SEND y SEARCH------------------------------------------------------------------------------------------------------
            ...
            if self.type=="send":
                ...
                if list!=[]:
                    ...
                    extension="null"        
                json_resp=json.dumps({"seccion":"#tablas", "html": html_seccion, "extension": extension, "limite": limite})
                html=json_resp
        ...
        if self.type=="send" or self.type=="search":
            ...
            #PROCESO PARA SEND-------------------------------------------------------------------------------------------------------
                ...
                if self.dpost["municipio_final"][0]!='none':
                    ...
                    self.municipio_final="vacio"
                if where=="WHERE ":
                    limite="No se ha introducido ningún critero de búsqueda, por lo tanto, solamente se muestran los primeros 100 resultados de las tablas urbana y rústica."
                    where="LIMIT 100 "
                else:
                    where2=where
                    limite="La búsqueda realizada es muy genérica, por lo tanto, solamente se muestran los primeros 1000 resultados de la búsqueda."
